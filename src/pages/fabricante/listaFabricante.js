            ...
            <div style={{margin: "5%", marginLeft: "20%", marginRight: "20%"}}>
                ...
                <table className="table table-bordered table-bordered" >
                    ...
                    <tr>
                        ...
                        <th scope="col">Nacionalidade da empresa</th>
                    ...
                    <tbody className="text-center">
                        {fabricantes.map((item, key) => {
                            return(
                                <tr>
                                    <td scope="row" >{item.nome}</td>
                                    <td scope="row" >{item.ddg}</td>
                                    <td scope="row" >{item.cnpj}</td>
                                    <td scope="row" >{item.nacionalidadeIndustria}</td>
                                    ...
                                    <td style={{display: "flex", justifyContent: "space-evenly"}}>
                                        ...
                                        <button className="btn btn-primary" style={{color: "white", textDecoration: "none"}} variant="warning"  onClick={e => navigate('/editarfabricante')}>
                                                Editar
