                        ...
                        <tr each="vacina: ${vacinas}">
                            ...
                            <td style={{display: "flex", justifyContent: "space-evenly"}}>
                                <button className="btn btn-primary"
                                        style={{color: "black", textDecoration: "none"}} variant="warning"  onClick={e => navigate('/editarvacina')}>
                                        Editar
                                ...
                                <button className="btn btn-danger" style={{color: "black", textDecoration: "none"}} variant="warning"  onClick={e => navigate('/')}>
                                        Deletar 
                                        <span>
